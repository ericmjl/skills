...
def cell_tour(mo):
    ...
    tour = wigglystuff.CellTour(
        steps=[
            {"cell_name": "hero", "title": "Linked Data Design", "description": "Six assay domains unified in one xarray Dataset."},
            ...
            {"cell_name": "stage2_binding", "title": "Binding Assays", "description": "ELISA dose-response curves across a concentration series."},
            {"cell_name": "stage2_fit", "title": "4PL Curve Fitting", "description": "Fit 4-parameter logistic curves to extract EC50 and Hill coefficient estimates."},
            {"cell_name": "stage3_cell_assays", "title": "Cell-Based Assays", "description": "Flow cytometry uptake data summarized as median MFI and percent positive."},
            {"cell_name": "stage4_functional", "title": "Functional Readouts", "description": "Cell viability EC50 and efficacy -- the go/no-go decision metrics."},
            {"cell_name": "stage5_genomics", "title": "Genomics", "description": "Perturbation RNA-seq: transcriptional signatures per molecule across a pathway gene panel."},
            {"cell_name": "unify_all", "title": "The Unified Dataset", "description": "One merge() call aligns all six stages by shared coordinates."},
            {"cell_name": "demo_cross_assay_query", "title": "Cross-Assay Query", "description": "Filter molecules by criteria spanning ALL assays simultaneously."},
        ],
        auto_start=False,
        show_progress=True,
    )
