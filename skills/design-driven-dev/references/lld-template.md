...
Brief description of this feature and its role in the system.

## Context

How this feature fits into the broader system. Reference the HLD.
...
| /api/feature | POST | FeatureCreateReq | FeatureResponse |
...
- [Sub-feature 1 EARS](./subfeature1-EARS.md)
- [Sub-feature 2 EARS](./subfeature2-EARS.md)
```
